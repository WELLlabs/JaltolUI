        ...
        <div className=" mx-auto py-16">
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <p className="text-lg text-gray-700 mt-4 text-justify">
              ...
              <br /><br />
              Taking this into account, we have implemented within Jaltol, a workflow for the <i>Difference in Difference</i> approach. The Difference in Difference (DiD) approach is a popular quasi-experimental research methodology used to estimate the causal effect of a specific intervention on an outcome of interest. This approach is particularly useful in observational studies where random assignment is not feasible. The basic premise of DiD is to compare the changes in outcomes over time between a group that is exposed to an intervention (intervention group) and a group that is not (control group).
              <br /><br />
              In this case of Jaltol, this means that the web app allows for comparison between village level rabi acreage between one village where an intervention was implemented (e.g. check dams, farm ponds, farm bunds etc) and another village where no such intervention was implemented.
            </p>
          </div>
          ...
          <div className="max-w-7xl mx-auto py-8 px-4">
            <h2 className="text-3xl font-semibold text-center mb-6">The Difference in Difference Estimator</h2>
            <div className="flex flex-col md:flex-row items-start md:space-x-6">
              ...
              <div className="flex-1 mt-6 md:mt-0">
                <img src={Difference} alt="DiD Estimator Illustration" className="rounded shadow-lg mx-auto w-full max-w-md" />
              </div>
            </div>
          </div>
          ...
          <div className="w-full bg-jaltol-blue py-8 mt-20">
            <div className="max-w-5xl mx-auto text-white">
              <h2 className="text-2xl font-semibold text-white">Assumptions</h2>
          ...
          <div className="w-full bg-jaltol-blue text-white py-8">
            <div className="max-w-5xl mx-auto">
          ...
          <div className="w-full py-8 px-4 flex flex-col justify-around bg-white">
            ...
            <div className="lg:w-2/3 mx-auto mt-8">
              <p className="text-gray-700 text-center">
                The methodology implemented in Jalmitra is not meant to be the final word on impact assessment but instead a reasonably accurate quick assessment tool which can be pointed to regions where more attention or primary data collection is needed for a comprehensive impact assessment.
              </p>
            </div>
          </div>
