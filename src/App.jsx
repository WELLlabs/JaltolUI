...
import WiserDashboardA from "./pages/WiserDashboardA";
import WiserDashboardB from "./pages/WiserDashboardB";
    ...
    <>
      ...
      <div className="App">
        ...
        <Routes>
          ...
          <Route path="/wiser/dashboard-a" element={<WiserDashboardA />} />
          <Route path="/wiser/dashboard-b" element={<WiserDashboardB />} />
